...
rm -rf package/openwrt-packages/luci-theme-edge
...
# 自定义定制选项
sed -i 's#192.168.1.1#192.168.1.233#g' package/base-files/files/bin/config_generate #定制默认IP
...
# LuCI主题:
cat >> .config <<EOF
CONFIG_PACKAGE_luci-theme-luci-theme-argon=y
